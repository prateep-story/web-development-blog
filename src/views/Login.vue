    ...
    <div class="row justify-content-center">
      <div class="col-md-3">
        <form class="m-5" v-on:submit.prevent="onLogin">
          <div class="text-center mb-3 animated fadeInUp">
          ...
          <button class="btn btn-primary btn-block rounded-0 animated fadeInUp" type="submit"><i class="fas fa-sign-in-alt"></i>
            Login</button>
        </form>
      </div>
    </div>
